      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ...
            records. On confirm they are sent to your configured Telegram chat and downloaded as
            “Turf bookings and sales - {year}.db” for your Documents folder, and only then removed
            from the app. If Telegram isn't set up yet, or either step fails, nothing is deleted.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
