...
/** Full-width on/off row: text on the left, switch pinned right. */
export function SettingsSwitchRow({
  ...
  return (
    <label className="frost-soft grid min-h-12 cursor-pointer grid-cols-[minmax(0,1fr)_auto] items-center gap-3 rounded-xl border px-3 py-2.5">
